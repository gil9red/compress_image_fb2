...
if __name__ == '__main__':
    ...
    with open(fb2_file_name, encoding='utf8') as fb2:
        xml = etree.XML(fb2.read().encode())

        binaries = xml.xpath("//*[local-name()='binary']")
        ...
        tree.write('compress_' + fb2_file_name, xml_declaration=True, encoding='utf-8')
    ...
    if compress_total_image_size:
        print()
        print('compress fb2 file size =', sizeof_fmt(os.path.getsize('compress_' + fb2_file_name)))
